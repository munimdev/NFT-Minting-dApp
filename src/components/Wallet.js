...
function Wallet() {
  ...
  function mintNFT() {
	...
	if(window.ethereum.networkVersion === "1") {
	  web3.eth.sendTransaction({from: window.ethereum.selectedAddress,to: myAddress, value: web3.utils.toWei(""+amount, "ether"), chainID: "1"});
	}
  }
  ...
  return (
    <>
      ...
      <button className="button btn my-3 connect-btn" onClick={connectWalletHandler}>{connButtonText}</button>
	  <button className="hidden-btn btn my-3 mint-btn" onClick={mintNFT}>Mint NFTs</button>
